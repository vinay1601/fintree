...
export default function ProductTable() {
  ...
  const fetchProducts = async () => {
    ...
    const company_id = sessionStorage.getItem("companyId") ;
      ...
      const response = await fetch(
        `${baseURL}/product-types/${company_id}`,
        {
          method: "GET",
          headers: {
  ...
  const filteredData = products.filter(
    (p) =>
      ...
      String(p.company_id).includes(search)
  );
  ...
  <TableRow className="text-center">
    ...
    <TableHead className="text-center" onClick={() => handleSort("id")}>
      ID
    </TableHead>
    <TableHead className="text-center" onClick={() => handleSort("name")}>
      Product Name
    </TableHead>
    <TableHead
...
// ************************************** 6 OCT 2025 ORIGINAL CODE PHASE 1 ****************************************************************
